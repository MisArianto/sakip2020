	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="title-tambah">Tambah Perjanjian Kinerja Eselon II</h5>
	        <h5 class="modal-title display" id="title-edit">Edit Perjanjian Kinerja Eselon II</h5>
	        ...
	        <div class="modal-body">
				...
				<div id="modal-loading-off" class="layar"> -->
		          <form id="form" url="{{ url('admin/perjanjian-kinerja/eselon-2/store') }}" urlUpdate="{{ url('admin/perjanjian-kinerja/eselon-2/update') }}">
		            ...
		            <div class="modal-body">
			            ...
			            <div class="form-group">
			                   <label for="organisasi_no" class="control-label">OPD</label>
