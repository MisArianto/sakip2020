	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="title-tambah">Tambah Perjanjian Kinerja Eselon III</h5>
	        <h5 class="modal-title display" id="title-edit">Edit Perjanjian Kinerja Eselon III</h5>
	        ...
	        <div class="modal-body">
				...
				<div id="modal-loading-off" class="layar"> -->
		          <form id="form" url="{{ url('admin/perjanjian-kinerja/eselon-3/store') }}" urlUpdate="{{ url('admin/perjanjian-kinerja/eselon-3/update') }}">
		            <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
		            <input type="hidden" class="display" name="id" id="id">
		            <input type="text" name="tahun_emit" id="tahun_emit">
		            <input type="text" name="organisasi_no_emit" id="organisasi_no_emit">
		            <div class="modal-body">

		            	<div class="form-group">
			            	<label for="sasaran" class="control-label">Organisasi</label>
			            ...
			            <div class="form-group">
			                   <label for="program_no" class="control-label">Program</label>
			                   <select class="form-control form-control-sm select2" name="program_no" id="program_no">
			                      <option value="">Pilih</option>
			                    </select>
			                    <span class="text-danger">
			                        <strong id="program_no_error"></strong>
			                    </span>
			            </div>
