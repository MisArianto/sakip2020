...
<br><br>
    <div class="tab-pane active" id="horizontal-form">
        <form action="{{ route('iki.store') }}" class="form-horizontal" method="POST">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="sasaran_strategis" type="text" class="form-control{{ $errors->has('sasaran_strategis') ? ' is-invalid' : '' }}" name="sasaran_strategis" value="{{ old('sasaran_strategis') }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="target" type="text" class="form-control{{ $errors->has('target') ? ' is-invalid' : '' }}" name="target">
