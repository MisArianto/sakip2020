...
<br>
    <div class="tab-pane active" id="horizontal-form">
        <form action="{{ url('perencanaan/perjanjian-kinerja/store-eselon-IV') }}" class="form-horizontal" method="POST">
            @csrf
            ...
            @elseif(Auth::user()->level == 2)
                ...
                <div class="col-sm-8">
                    ...
                    <option {{ old('indikator_kegiatan_id') ? 'selected' : '' }} value="{{ $ik->id }}">{{ $ik->indikator_kegiatan }}</option>
                    @endforeach
                    </select>
