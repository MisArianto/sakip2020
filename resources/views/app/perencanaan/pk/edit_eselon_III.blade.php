...
<div class="box box-default" style="padding: 10px;">
            <div class="box-header with-border">
              <h3 style="color: #007bff; ">Edit Perjanjian Kinera Eselon 3</h3>
            </div>

<br>
    <div class="tab-pane active" id="horizontal-form">
        <form action="{{ url('perencanaan/perjanjian-kinerja/update-eselon-III', $model->id) }}" class="form-horizontal" method="POST">
            @csrf
            ...
            @elseif(Auth::user()->level == 2)
                ...
                <div class="col-sm-8">
                    ...
                    <option @if($ip->id === $model->indikator_program_id) selected @endif value="{{ $ip->id }}">{{ $ip->indikator_program_nama }}</option>
                    @endforeach
                    </select>
