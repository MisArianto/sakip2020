...
<div class="box box-default" style="padding: 15px;">
	...
	<h4> Rencana Strategis @foreach($opds as $o)
		{{$o->organisasi_nama}}
	@endforeach 
    </h4>
	</div>
...
<div class="box-body">
	...
	<ul class="nav nav-pills">
			...
			<li class="active"><a data-toggle="tab" href="#tujuan-sasaran">Tujuan dan Sasaran</a></li>
			<li><a data-toggle="tab" href="#progkeg">Program & Kegiatan</a></li>
	</ul>
    <div class="tab-content">
		{{-- <div id="tujuan" class="tab-pane fade in active">@include('app.perencanaan.renstra-opd._tujuan')</div> --}}
		<div id="tujuan-sasaran" class="tab-pane fade in active">@include('app.perencanaan.renstra-opd._tujuan-sasaran')</div>
		<div id="progkeg" class="tab-pane fade">@include('app.perencanaan.renstra-opd._program_kegiatan')</div>
	</div>
