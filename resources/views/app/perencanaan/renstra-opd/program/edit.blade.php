...
<br>
    <div class="tab-pane active" id="horizontal-form">
        <form action="{{ route('renstra-program.update',$model->renstra_id) }}" class="form-horizontal" method="POST">
            {{ csrf_field() }}
            ...
            <input type="hidden" name="_method" id="PUT">
                ...
                <div class="col-sm-8">
                    ...
                    <option @if($is->id == $model->indikator_sasaran_id) selected @endif value="{{ $is->id }}">{{ $is->indikator_sasaran_nama }}</option>
                    @endforeach
                    </select>
