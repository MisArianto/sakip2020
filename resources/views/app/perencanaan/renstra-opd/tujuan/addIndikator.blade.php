...
<div class="box box-default" style="padding: 10px;">
            <div class="box-header with-border">
              <h3 style="color: #0086a5; ">Tambah Indikator Tujuan</h3>
            </div>

<br>
    <div class="tab-pane active" id="horizontal-form">
            <form action="{{ url('perencanaan/rencana-strategis-opd/tambah-indikator-tujuan/store') }}" class="form-horizontal" method="POST">
               @csrf
