        ...
        <form action="{{ route('renstra-program.store') }}" class="form-horizontal" method="POST">
            ...
            @elseif(Auth::user()->level == 2)
                ...
                <div class="col-sm-8">
                    ...
                    <option {{ old('indikator_sasaran_id') ? 'selected' : '' }} value="{{ $is->id }}">{{ $is->indikator_sasaran }}</option>
                    @endforeach
                    </select>
            ...
            <div class="form-group">
                <label for="sasaran_kegiatan" class="col-sm-2 control-label">{{ __('Sasaran Kegiatan') }}</label>
                <div class="col-sm-8">
                    <textarea id="sasaran_kegiatan" class="form-control {{ $errors->has('sasaran_kegiatan') ? ' is-invalid' : '' }}" name="sasaran_kegiatan" placeholder="Sasaran Kegiatan.."></textarea>
                    @if ($errors->has('sasaran_kegiatan'))
                        <span class="text-danger">
                            <strong>{{ $errors->first('sasaran_kegiatan') }}</strong>
                        </span>
                    @endif
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <option {{ old('satuan_id') ? 'selected' : '' }} value="{{ $data->id }}">{{ $data->satuan_nama }}</option>
                    @endforeach
                    </select>
