...
<div class="box box-default" style="padding: 10px;">
            <div class="box-header with-border">
              <h4>Tambah Indikator Sasaran</h4>
            </div>

<br>
    <div class="tab-pane active" id="horizontal-form">
        <form action="{{ url('perencanaan/rencana-strategis/tambah-indikator-sasaran/store') }}" class="form-horizontal" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select id="organisasi_no" class="form-control{{ $errors->has('org') ? ' is-invalid' : '' }} select2" name="organisasi_no">
            ...
            <input type="hidden" name="organisasi_no" value="{{Auth::user()->organisasi_no}}">
                ...
                <label for="sasaran_id" class="col-sm-2 control-label">Sasaran</label>
                <div class="col-sm-8">
                    <select class="form-control select2" name="sasaran_id">
