...
<script>
    ...
    function fetch_data(){
        ...
        $.ajax({
            type: 'GET',
            url: '{{ url("user/perencanaan/renstra/sasaran-renstra/fetch") }}',
            success: function(res)
            {
            	// console.log(res.api_indikator_sasaran_renstra)
                $('#load').html(res.sasaran_renstras)
