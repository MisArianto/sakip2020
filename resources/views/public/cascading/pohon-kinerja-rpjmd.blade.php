        ...
        <table class="table table-responsive table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                         <a href="{{ \Storage::path('public/cascading_rpjmd/'.$data->nama_file) }}" id="embedURL"></a>
                         {{-- <img src="pdf-thumb-1.png" href="{{ \Storage::path('public\cascading_rpjmd\\'.$data->nama_file) }}"> --}}
...
{{-- <script src="{{ asset ('js/EZView/EZView.js')}}"></script> --}}
{{-- <script src="{{ asset ('js/EZView/draggable.js')}}"></script> --}}
